...
export function FinalCTABanner() {
  return (
    <section className="relative overflow-hidden bg-mesh-brand py-20 sm:py-28">
      <div
        aria-hidden
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,0.05),_transparent_65%)]"
      />
      <div className="relative mx-auto max-w-3xl px-6 text-center lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Ready to Improve Operations and Grow Your Business?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-white/70">
            Let&apos;s discuss how NAC can help your healthcare business operate better and grow
            faster.
          </p>
