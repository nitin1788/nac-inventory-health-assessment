...
/**
 * No photo in this section: the previously supplied source image
 * (public/images/strategy/nac-healthcare-business-strategy.webp) has a
 * fabricated "NAC Impact Summary" dashboard baked into it (invented
 * +28%/+35%/-20%/+40% results), which conflicts with the no-fake-
 * statistics rule — a CSS crop can't fix this since the raw file is
 * still directly and publicly servable with the numbers intact. File
 * preserved, optimized, but unreferenced — see NAC_SEO_READINESS_AUDIT.md.
 * Text-only layout matches the pattern already used for industry pages
 * without a qualifying photo.
 */
