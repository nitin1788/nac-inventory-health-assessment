...
export function InventoryHubPage() {
  return (
    <ServiceVerticalHubView
      ...
      intro="Structured, practical consulting for how pharmacy, healthcare, and allied businesses handle stock and run day-to-day operations — from inventory audits and expiry control to SOPs and KPI dashboards."
